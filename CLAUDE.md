...
6. **Location-specific file naming (`docs/medical/`).** Files covering a specific medical specialty and suburb live under `docs/medical/{specialty}/` and **must** use this filename format:
   ...
   **Examples:**
   - `docs/medical/dental/macquarie-park-nsw.md` — dental clinics in Macquarie Park, NSW
   - `docs/medical/endocrinology/north-sydney-nsw.md` — endocrinology practices in North Sydney, NSW
   - `docs/medical/general-practice/parramatta-nsw.md` — GP clinics in Parramatta, NSW
   - `docs/medical/pharmacy/chatswood-nsw.md` — pharmacies in Chatswood, NSW

   This mirrors the web page hierarchy exactly — any agent can derive the docs path from the URL and vice versa without translation:

   | Web page | Docs file |
   |---|---|
   | `medical/dental/macquarie-park/index.html` | `docs/medical/dental/macquarie-park-nsw.md` |
   | `medical/endocrinology/north-sydney/index.html` | `docs/medical/endocrinology/north-sydney-nsw.md` |
