...
> ⚠️ **Before modifying this file:** If the content you are adding applies to more than one agent file, it belongs in [`.specify/memory/constitution.md`](.specify/memory/constitution.md) — not here. This file is for ChatGPT-specific behaviour only. Anything shared across agents is constitution content.
