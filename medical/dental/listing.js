 ...
 * Dental / Specialist Listing page
...
function initMapInteraction() {
  ...
  mapRows.forEach((row) => {
    // Rows are plain <li> (unlike the pins, which are role="button" tabindex=0).
    // Make them keyboard-operable so the interaction is not mouse-only.
